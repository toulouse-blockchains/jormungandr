...
impl Generate {
    fn exec(self) -> Result<(), Error> {
        let priv_key_bech32 = match self.key_type {
            ...
            GenPrivKeyType::FakeMMM => gen_priv_key::<FakeMMM>(self.seed)?,
...
impl ToPublic {
    fn exec(self) -> Result<(), Error> {
        ...
        let pub_key_bech32 = match bech32.hrp() {
            ...
            FakeMMM::SECRET_BECH32_HRP => gen_pub_key::<FakeMMM>(data),
...
impl FromBytes {
    fn exec(self) -> Result<(), Error> {
        ...
        let priv_key_bech32 = match self.key_type {
            ...
            GenPrivKeyType::FakeMMM => bytes_to_priv_key::<FakeMMM>(&bytes)?,
